...
<body class="custom-cursor">
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="/" aria-label="logo image"><img src="<?php echo e(asset('assets/images/resources/logo-1.png')); ?>"
                        width="89" alt="" /></a>
            </div>
            <!-- /.logo-box -->
    ...
    <div class="search-popup">
        ...
        <div class="search-popup__content">
            <form action="<?php echo e(route('berita.cari')); ?>" method="get">
                ...
                <input type="text" id="search" name="key" value="<?php echo e(e(request('key'))); ?>" placeholder="Cari disini..." />
...
<?php /**PATH /Users/ineza/Desktop/kotabogor/front/resources/views/layouts/home-layout.blade.php ENDPATH**/ ?>