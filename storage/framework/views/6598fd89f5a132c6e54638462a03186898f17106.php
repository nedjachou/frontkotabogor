    ...
    <div class="container">
        <div class="information__inner">
            <div class="information__logo-box">
                ...
                <a href="/"><img src="<?php echo e(asset('assets/images/resources/information-logo.png')); ?>"
                        alt="" /></a>
            </div>
...
<footer class="site-footer">
    <div class="site-footer-shape-1"
        style="
        background-image: url(<?php echo e(asset('assets/images/shapes/site-footer-shape-1.png')); ?>);
      ">
    </div>
    <div class="site-footer-shape-two">
        <img src="<?php echo e(asset('assets/images/shapes/tes.png')); ?>" alt="" />
    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                    <div class="footer-widget__column footer-widget__articles clearfix">
                        ...
                        <ul class="footer-widget__articles-list list-unstyled clearfix">
                            <?php $__currentLoopData = $berita->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <div class="footer-widget__articles-img">
                                        <img src="<?php echo e(config('app.eksternal_link')); ?>/storage/data/<?php echo e($row->file); ?>"
                                            alt="" />
                                        <a href="<?php echo e('/berita-detail/' . $row->id); ?>"><span
                                                class="fa fa-link"></span></a>
                                    </div>
                                    <div class="footer-widget__articles-content">
                                        <p class="footer-widget__articles-date">
                                            <?php echo e(date('d, M-Y', strtotime($row->tgl_publikasi))); ?>
...
<?php /**PATH /Users/ineza/Desktop/kotabogor/front/resources/views/includes/footer.blade.php ENDPATH**/ ?>